class CustomerPage {
  ...
  constructor() {
    ...
    this.$customerContactName = document.querySelector('#ContactName');
    this.$customerSalesPersonName = document.querySelector('#SalesPersonName');
  ...
  clearCustomerFields() {
    ...
    this.$customerSalesPersonName.value = "";
  }
  ...
  makeFieldsReadOnly(readOnly=true) {
    ...
    this.$customerContactName.readOnly = readOnly;
    this.$customerSalesPersonName.readOnly = readOnly;
  }
  ...
  makeFieldsRequired(required=true) {
    ...
    this.$customerSalesPersonName.required = required;
  }
